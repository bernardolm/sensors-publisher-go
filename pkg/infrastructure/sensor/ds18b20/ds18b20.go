...
func (s *ds18b20) Class() measurement.Class {
	return s.class
}

func (s *ds18b20) Icon() string {
	return s.icon
}
...
func (s *ds18b20) Manufacturer() string {
	return s.manufacturer
}

func (s *ds18b20) Model() string {
	return s.model
}

func (s *ds18b20) Picture() string {
	return s.picture
}

func (s *ds18b20) Time() time.Time {
	return s.time
}

func (s *ds18b20) UnitOfMeasurement() measurement.UnitOfMeasurement {
